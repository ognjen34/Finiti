...
@Component({
  selector: 'app-table',
  standalone: true,
  imports: [CommonModule, MatTableModule, MatPaginatorModule, FormsModule, MatFormFieldModule, MatInputModule],
...
export class Table implements OnInit {
  ...
  loadData() {
    const filter: PaginationFilter = {
      pageNumber: this.pageIndex + 1,  // API page numbers start at 1
